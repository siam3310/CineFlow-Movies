...
const fetchAnimeData = async (pageNum) => {
  let config = {
    ...
    url: `https://thingproxy.freeboard.io/fetch/https://api.anix.my/movies/filter?limit=40&select=slug%2Cmovie%2Ctype%2Clatest_episode%2Cthumb%2Cname%2Csub_category%2Creleased_year%2Cgenres%2Cstate%2Cintro%2Ccreated_at%2Cother_names&sort_by=latest_episode.created_at&page=${pageNum}`,
...
const fetchSearchData = async (query) => {
  let config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `https://thingproxy.freeboard.io/fetch/https://api.anix.my/movies/filter?limit=80&keywords=${query}`,
